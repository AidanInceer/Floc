/* Why: the ERD is unreadable at page width, so each diagram gets pan, zoom and
 * expand. No fetch — this has to run from the file:// origin.
 */
...
(function () {
  ...
  function enhance(pre) {
    ...
    // Mermaid caps the svg width and drops its height, which fights the transform.
