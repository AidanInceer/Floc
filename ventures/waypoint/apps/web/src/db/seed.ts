    ...
    .values([
      {
        ...
        time: "10:15",
        note: "Birmingham → Lisbon (Aidan + Priya on the same flight)",
        placeId: lisbon.id,
      },
      {
        dayId: dayRows[0].id,
        ...
        type: "activity",
        time: "19:30",
        note: "Dinner in Alfama, nothing booked",
        placeId: lisbon.id,
      },
      {
        dayId: dayRows[1].id,
        orderIndex: 0,
        type: "activity",
        note: "Tram 28 early, before the queues",
        placeId: lisbon.id,
      },
      {
        dayId: dayRows[3].id,
